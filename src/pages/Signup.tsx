          ...
          {!showEmailForm ? (
            <>
              ...
              <Button 
                ...
                disabled={loading}
              >
                <svg className={`${isRTL ? 'ml-2' : 'mr-2'} h-4 w-4`} viewBox="0 0 24 24">
              ...
              <Button 
                ...
                disabled={loading}
              >
                <svg className={`${isRTL ? 'ml-2' : 'mr-2'} h-4 w-4`} fill="currentColor" viewBox="0 0 24 24">
            ...
            <form onSubmit={handleEmailSignup} className="space-y-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="phone">{t.auth.phoneNumber} (Optional)</Label>
                <Input
                  id="phone"
                  type="tel"
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center text-xs text-primary">
                    ...
                    <span>{t.auth.birthdayBonus}</span>
                  </div>
                </div>
                <Input
                  id="birthday"
